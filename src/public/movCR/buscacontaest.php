...
<body>
	<div id="pagina">
        ...
        <div id="conteúdo">
        	<div id="topo">
            	<div class="barraTitulo">Estornar Conta►Selecionar Conta</div>
                <?php
					if(isset($_GET['id'])){
						$idcli = $_GET['id'];
            ...
            <div id="lancamento">
            	<div class="barraTitulo">Estornar Conta</div>
                <form id="confestornarconta" action="estornarconta.php" method="get">
    ...
    <script type="text/javascript" src="js/buscacontaest.js"></script>
</body>
</html>