<?php
		...
		verificaLogin('CADFORNECEDORJUR');
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Pear - Cadastro de Fornecedor</title>
...
<body>
    <div id="pagina">
        ...
        <div id="conteúdo">
        	<div class="barraTitulo">Cadastros►Fornecedor►Pessoa Jurídica</div>
            <br />
        	<fieldset style="width:500px; left:50%; margin-left:-250px; position:relative;">
        	<form id="frmcadfornecedor" action="salvarfornecedor.php" method="get" onsubmit="return false">
            	<input type="hidden" name="idfor" id="idfor" value="NULL" />
                ...
                <input type="text" name="razsoc" id="razsoc" size="60" maxlength="80" style="text-transform:uppercase" /><br />
                <label for="fantasia">Fantasia</label>
                <input type="text" name="fantasia" id="fantasia" size="60" maxlength="80" style="text-transform:uppercase" /><br />
                <label for="cnpjcpf">CNPJ*</label>
                <input type="text" name="cnpjcpf" id="cnpjcpf" size="24" maxlength="18" /><br />
                <label for="ierg">IE</label>
                <input type="text" name="ierg" size="24" /><br />
                <label for="endereco">Endereço</label>
                <input type="text" name="endereco" id="endereco" size="60" style="text-transform:uppercase" /><br />
                <label for="bairro">Bairro</label>
                <input type="text" name="bairro" id="bairro" size="60" style="text-transform:uppercase" /></td>
