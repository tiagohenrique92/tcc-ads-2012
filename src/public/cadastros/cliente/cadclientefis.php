...
<body>
    ...
    <div id="pagina">
        ...
        <div id="conteúdo">
        	<div class="barraTitulo">Cadastros►Cliente►Pessoa Física</div>
            <br />
        	...
        	<form id="frmcadcliente" action="salvarcliente.php" method="get" onsubmit="return false">
                ...
                <input type="text" name="nome" id="nome" size="60" maxlength="80" style="text-transform:uppercase" /><br />
                <label for="cnpjcpf">CPF*</label>
                <input type="text" name="cnpjcpf" id="cnpjcpf" size="24" maxlength="14" /><br />
                 <label for="ierg">RG</label>
