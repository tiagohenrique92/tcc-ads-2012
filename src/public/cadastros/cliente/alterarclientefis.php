<?php
	...
	verificaLogin('ALTERARCLIENTEFIS');
?>
...
<body>
    <div id="pagina">
        ...
        <div id="conteúdo">
        	<div class="barraTitulo">Cadastros►Cliente►Alterar►Pessoa Física</div>
            <br />
        	<fieldset style="width:500px; left:50%; margin-left:-250px; position:relative;">
        	<form name="frmcadcliente" id="frmcadcliente" action="salvarcliente.php" onsubmit="return false" method="post">
                ...
                <input type="text" name="nome" size="60" maxlength="80" style="text-transform:uppercase" value="<?php echo $_POST['nome']; ?>" /><br />
                <label for="cnpjcpf">CPF</label>
                <input type="text" name="cnpjcpf"  size="25" value="<?php echo $_POST['cnpjcpf']; ?>" /><br />
                <label for="ierg">IE</label>
                <input type="text" name="ierg" size="25" value="<?php echo $_POST['ierg']; ?>" /><br />
                <label for="endereco">Endereço</label>
                <input type="text" name="endereco" size="60" style="text-transform:uppercase" value="<?php echo $_POST['endereco']; ?>" /><br />
                <label for="bairro">Bairro</label>
                <input type="text" name="bairro" size="60" style="text-transform:uppercase" value="<?php echo $_POST['bairro']; ?>" /><br />
