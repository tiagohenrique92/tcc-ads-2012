...
<div class="menu">
	<ul>
		...
		<!--<li><a href="" target="_parent" >Compra</a>
			<ul>
				<li><a href="novacompra.php" target="_parent">Nova</a></li>
				<li><a href="buscaclicompra.php" target="_parent">Alterar</a></li>
			</ul>
		</li>-->
		<li><a href="" target="_parent" >Contas a Receber</a>
			<ul>
				<li><a href="<?php echo $servidor;?>buscacliconta.php" target="_parent">Baixar</a></li>
			</ul>
		</li>
<!--		<li><a href="" target="_parent" >Relatório</a>
			<ul>
				<li><a href="ctiporelvendas.php" target="_parent">Vendas</a></li>
				<li><a href="ctiporelcompras.php" target="_parent">Compras</a></li>
