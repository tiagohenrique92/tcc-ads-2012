<?php
	...
	if(isset($_GET['id'])){
		$idfor = $_GET['id'];
		$ordem = $_GET['ordem'];
		$sql = "select parcelapag.*, compra.idfor, compra.datacompra from parcelapag, compra where (compra.idfor = $idfor) and (parcelapag.idcompra = compra.idcompra) and (parcelapag.status in ('P', 'PA')) order by $ordem, numparc, idcompra";
		...
		<table>
			<tr>
				<td width="55px">Compra</td>
				<td width="120px">Data Compra</td>
				<td width="55px">Nº da Parcela</td>
